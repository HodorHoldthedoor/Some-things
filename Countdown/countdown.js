...
//var endTime= new Date(2017,6,4,18,47,52);   //这里6代表7月，如果是0代表1月
...
window.onload=function(){
    ...
    if (canvas.getContext("2d")){
    	...
    	setInterval(
    		function(){
    			render(context);      //负责绘制小球，所以所有绘制小球的任务都在这里完成
    			update();             //负责更新小球状态
    	},50);
...
//计算显示的时间(这里是计算倒计时时间，稍作修改即可改为显示时间的时钟)
